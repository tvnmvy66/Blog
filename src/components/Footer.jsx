...
function Footer() {
  return (
    ...
    <div className="pt-4 border-t border-slate-200 sm:flex justify-between text-slate-500">
        <div className="mb-6 sm:mb-0 sm:flex">
            <p>Copyright © 2023 Tailwind Labs Inc.</p>
            <p className="sm:ml-4 sm:pl-4 sm:border-l sm:border-slate-200"><a
                    className="hover:text-slate-900" href="/brand">Trademark Policy</a>
            </p>
        </div>
